    ...
    return (
        <div className='bg-white p-6 mt-10 rounded-lg shadow-md min-w[220px]'>
            <div className='text-center'>
                ...
                <span className='text-slate-400 text-sn font-mediun'>{`${location.region}, ${location.country}`}</span>
            </div>

            <div className='font-bold text-slate-700 flex justify-center nt-4 mb-2'>
